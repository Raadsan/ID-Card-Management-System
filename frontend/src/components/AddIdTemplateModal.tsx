...
const AddIdTemplateModal: React.FC<AddIdTemplateModalProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!files.front) {
            setError("Front background image is required.");
            return;
        }
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="New ID Card Template" maxWidth="max-w-2xl">
            <form onSubmit={handleSubmit} className="px-2 py-4">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="h-16 w-16 rounded-2xl bg-gray-50 flex items-center justify-center text-[#16BCF8]/20 border-2 border-dashed border-gray-100">
                            <Layout size={32} />
                        </div>
                    </div>
