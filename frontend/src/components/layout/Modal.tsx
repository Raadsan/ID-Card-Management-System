...
const Modal = ({ isOpen, onClose, title, children, maxWidth = "max-w-2xl" }: ModalProps) => {
    ...
    return (
        ...
        >
            <div
                ref={modalRef}
                className={`${maxWidth} w-full transform overflow-hidden rounded-3xl bg-white px-8 py-6 text-left align-middle shadow-2xl transition-all border border-gray-100 relative`}
