        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            {showAddButton && onAddClick && (
              <button
                onClick={onAddClick}
                className="w-full sm:w-auto bg-[#1B1555] hover:bg-[#16BCF8] text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition-all shadow-md active:scale-95"
              >
